          ...
          case 2
            ...
            next
              case 2
                ...
                then have "{y} \<subseteq> I" using Predict_def y_in_I by simp                
                with zy have "z \<in> Predict k' I" using Predict_def bin_def y_in_I  apply(auto) 
                  by (simp add: bin_def)
