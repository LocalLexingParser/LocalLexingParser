...
definition finished_item :: "('a, 'b) symbol list \<Rightarrow> ('a, 'b) item"
where
...
definition pvalid_with :: "('a, 'b, 'c )tokens \<Rightarrow> ('a, 'b) item \<Rightarrow> nat \<Rightarrow> ('a, 'b) symbol list \<Rightarrow> bool"
where
