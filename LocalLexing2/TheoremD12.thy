...
proof -
  {
    ...
    next
      case 2
            ...
            case less
              ...
              next
                case 2
                  ...
                  have item_rhs_x:"snd (item_rule x) = \<alpha>@\<beta>" using item_rhs_def \<alpha> \<beta> item_rhs_split by metis
                  have item_nonterminal_x:"fst (item_rule x) = N" using N item_nonterminal_def by metis
                  have item_rule_id: "item_rule x = (fst (item_rule x), snd(item_rule x))" by simp
                  with item_rhs_x item_nonterminal_x have item_rule_x:"item_rule x = (N, \<alpha>@\<beta>)" by simp
        ...
        then show ?case
          using LocalLexing.items_le_def LocalLexing_axioms pvalid_item_end q by fastforce
    qed
  }
